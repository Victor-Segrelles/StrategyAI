...
public class ClericPlaceHolder : CharacterPlaceHolder
{
    ...
    public void Smite(CharacterPlaceHolder target)
    {
    ...
    private IEnumerator PlaySmiteVFX(CharacterPlaceHolder target)
    {
    ...
    public void Heal(CharacterPlaceHolder target)
    {
    ...
    private IEnumerator PlayHealVFX(CharacterPlaceHolder target)
    {
