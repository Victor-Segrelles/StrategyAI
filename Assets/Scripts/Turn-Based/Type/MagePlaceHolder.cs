...
public class MagePlaceHolder : CharacterPlaceHolder
{
    ...
    public void ArcaneMissiles(CharacterPlaceHolder target1, CharacterPlaceHolder target2, CharacterPlaceHolder target3)
    {
    ...
    private IEnumerator PlayArcaneMissileVFXAndHit(CharacterPlaceHolder target1, CharacterPlaceHolder target2, CharacterPlaceHolder target3)
    {
