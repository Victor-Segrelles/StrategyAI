...
public class CheckSingleShot : NodeBT
{
    private Unit unit;

    public CheckSingleShot(Unit obj)
    {
        unit = obj;
    }
    ...
    public override NodeState Evaluate()
    {
        ...
        object t = GetData("CheckSingleShot");
        if (t == null || unit.actionTarget == null)
        {
            ...
            if (odiado != null)
            {
                ...
                parent.parent.SetData("CheckSingleShot", unit.actionTarget);
